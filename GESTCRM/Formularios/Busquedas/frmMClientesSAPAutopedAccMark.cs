...
{
    public partial class frmMClientesSAPAutopedAccMark : Form
    {
        ...
        public frmMClientesSAPAutopedAccMark()
        {
            InitializeComponent();
        ...
        private void frmMClientesSAPAutopedAccMark_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void BuscarClientes()
        {
            try
            {
                ...
                this.dsBuscar1.ListaBuscaClientesSAPConAutopedsSinAccMark.Rows.Clear();

                this.sqldaListaBuscaClientesSAPConAutopedsSinAccMark.SelectCommand.Parameters["@iIdDelegado"].Value = this.ParamI_iIdDelegado;
                this.sqldaListaBuscaClientesSAPConAutopedsSinAccMark.SelectCommand.Parameters["@sIdCliente"].Value = tsIdCliente;
                this.sqldaListaBuscaClientesSAPConAutopedsSinAccMark.SelectCommand.Parameters["@sNombre"].Value = tsNombre;

                Application.DoEvents();

                this.sqldaListaBuscaClientesSAPConAutopedsSinAccMark.Fill(this.dsBuscar1.ListaBuscaClientesSAPConAutopedsSinAccMark);
                if (this.dsBuscar1.ListaBuscaClientesSAPConAutopedsSinAccMark.Rows.Count > 0)
                {
                    this.dgClientes.CurrentCell = new DataGridCell(0, 1);
                    this.dgClientes.CurrentCell = new DataGridCell(0, 0);
                    this.lblNumReg.Text = this.dsBuscar1.ListaBuscaClientesSAPConAutopedsSinAccMark.Rows.Count.ToString();
                }
                else
        ...
        {
            for (int i = 0; i < this.dsBuscar1.ListaBuscaClientesSAPConAutopedsSinAccMark.Rows.Count; i++)
            {
